...
### Senior Instructional Designer & Content Architect | Nov 2021 – May 2023
...
### Senior Instructional Designer & Product Lead | Mar 2021 – Oct 2021
**VietAccepted** — Ho Chi Minh City, Vietnam
*VietAccepted is a premier training hub for GMAT/GRE and English certifications for high-potential professionals in Vietnam.*
- **Orchestrated** the production of brand-consistent instructional assets and visual learning modules for 1,000+ adult learners across multiple digital channels.
- **Conducted** regular formative assessments using standardized examiner-style marking for high-stakes speaking and writing modules.
- **Standardized** instructional design workflows by implementing quality control templates, reducing cross-departmental content friction by **20%**.
- **Influenced** product direction by analyzing learner feedback loops, leading to a UI/UX update for the student portal.
- **Consolidated** a centralized repository of 1,000+ reusable instructional assets, ensuring brand consistency across rapid-launch marketing and academic campaigns.

### LMS Architect & Experience Designer | Jul 2019 – Oct 2020
...
### Senior Instructional Designer & Curriculum Lead | Sep 2017 – Jun 2019
**ZIM Academy** — Ho Chi Minh City, Vietnam
*ZIM is an academic institution providing intensive English preparation and personalized educational consulting for international certification candidates.*
- **Managed** trainer induction and instructional audits for **6+ new teachers** during a period of rapid center-wide expansion.
- **Implemented** systematic classroom observation cycles and feedback loops, improving instructional consistency across 4+ branches.
- **Standardized** the IELTS Writing curriculum for the "High Performance" track, contributing to a **10% increase** in Band 7.0+ attainment within 6 months.
- **Facilitated** a teacher-training community of practice, reducing turnover among new hires by providing rapid pedagogical support and resource sharing.
- **Authored** 10+ comprehensive teacher guides and student workbooks, ensuring 100% adherence to signature pedagogical methodologies.

## PORTFOLIO PROJECTS
- **The Deadline Crisis Simulator (Storyline 360):** Advanced branching simulation with custom **JavaScript data bridge** to Google Sheets API for real-time tracking.
- **Universal LMS Scalability (Moodle LMS):** End-to-end automated LMS architecture with complex activity gating, mastery-based feedback, and adaptive paths.
- **Modern Employee Onboarding (Rise 360):** Aesthetic technical onboarding case study highlighting agile deployment and mobile-first UX principles.

## EDUCATION & CERTIFICATIONS
**Ho Chi Minh City Open University**, *B.A. English* (2019-23) | **Hoa Sen University**, *B.S. IT* (2010-16)
**Certifications:** IELTS Teacher Training (IDP & BC) | TESOL | Cambridge Teaching English Online
